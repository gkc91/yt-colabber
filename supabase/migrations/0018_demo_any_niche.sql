-- 0018_demo_any_niche.sql — nişinde test yoksa herhangi bir nişten örnek test.
--
-- Bulgu (2026-09-24, canlı): gerçek hesapla giren kullanıcı "Nothing to review" gördü.
-- Örnek testler yalnızca kendi nişlerine çıkıyordu; 15 niş için 15 örnek gerekirdi.
-- Artık kişinin nişinde/kapsamında hiçbir şey yoksa, herhangi bir nişteki örnek test
-- gösteriliyor. Gerçek testlerin eşleştirmesi değişmedi.
--
-- Feed'deki decoy'lar örnek testin KENDİ nişinden gelir (v_sub.niche_id) — ızgara kendi
-- içinde tutarlı kalsın.
